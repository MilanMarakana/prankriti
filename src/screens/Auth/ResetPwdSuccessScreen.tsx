...
const ResetPwdSuccessScreen: React.FC<Props> = ({navigation}) => {
  useEffect(() => {
        ...
        <View style={styles.container}>
          <View style={styles.contentContainer}>
            <View style={styles.imageContainer}>
              <Image
                source={require('../../assets/images/information-success.png')}
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.subtitle}>
                Your password has been successfully changed. Please proceed to
                the login page by pressing the button below
              </Text>
            </View>
          </View>
          <CommonBtn
