...
const SuccessSubscribeScreen: React.FC<Props> = ({navigation}) => {
  useEffect(() => {
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.subtitle}>
                "You've successfully subscribed to our premium service for 1
                year. Get ready to enjoy a year of exclusive plant care benefits
                and enhanced services. Thank you for choosing Prankriti. Happy
                planting!"
              </Text>
            </View>
          </View>
...
export default SuccessSubscribeScreen;
